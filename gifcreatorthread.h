#ifndef GIFCREATORTHREAD_H
#define GIFCREATORTHREAD_H
...
public:
    explicit  GitRaw(QObject *parent = nullptr);
    ~GitRaw();
public slots:
...
private:
    ...
    QThread   mWorkThread;
    friend class GifCreatorThread;
};

class GifCreatorThread : public QObject
{
    Q_OBJECT
public:
    explicit GifCreatorThread(QObject *parent = nullptr);
    ~GifCreatorThread();
